...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    connection_options={
        ...
        "recurse": True, #to read all files-> here u dont need mention the file name. just mention till last folder name. This is line is not needed here.bcz we are specifying the full path with file name
    },
